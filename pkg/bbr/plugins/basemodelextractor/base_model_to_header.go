...
// WithName sets the name of the BBR plugin
...
func (p *BaseModelToHeaderPlugin) ProcessRequest(ctx context.Context, request *framework.InferenceRequest) error {
	...
	log.FromContext(ctx).V(logutil.VERBOSE).Info("parsed field from body", "field", modelField, "value", targetModel, "baseModel", baseModel)
	return nil
}
